...
const Header = () => {
    return (
        <div className='flex flex-col items-center justify-center my-20'>
            <div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 rounded-full border border-neutral-500'>
                <p>Best text to image generator</p>
                <img src={assets.star_icon} alt='start icon'></img>
            </div>
            ...
            <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'>
                Generate Images
                <img className= " h-5" src={assets.star_group} alt='star group'></img>
            </button>
